...
public class FlightBookingSystem {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Flight f3 = new Flight("AA1234", new Date(), "American Airlines", "JFK", "LAX");
        ...
        FirstClassBooking b5 = new FirstClassBooking("Kevin", "Freebie", 0, "Lachsfilet in Champagnersauce", true, true);
